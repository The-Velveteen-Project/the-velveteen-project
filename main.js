...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const i18n = {
    ...
    es: {
      ...
      "hero.eyebrow": "ESTADO DEL SISTEMA // DIRIGIDO POR SU FUNDADOR",
      "hero.sub": "LABORATORIO DE SISTEMAS DE <span class=\"accent\">DECISIÓN</span> APLICADOS",
      "hero.desc": "Construimos herramientas que combinan modelado matemático, machine learning, NLP y sistemas de agentes para lograr que las decisiones complejas sean más claras y ejecutables.",
      ...
      "hero.graph.subnote": "Los modelos estructuran la incertidumbre. Los sistemas revelan las decisiones.",
